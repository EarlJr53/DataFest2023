...
df_responses %>% 
  # mutate_at(c('response_rate', 'StateAbbr'), as.factor) %>%
  # mutate(StateAbbr = fct_reorder(StateAbbr, response_rate)) %>% 
  ggplot() +
  geom_col(aes(
...
Find the number of active attorneys in our 15 relevant states
